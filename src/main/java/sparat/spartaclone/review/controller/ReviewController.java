...
public class ReviewController {
    ...
    public ApiResponse<ReviewsDetailsResponseDto> createReview(@ModelAttribute ReviewRequestDto requestDto,
        ...
        return ApiResponse.successOf(HttpStatus.CREATED, reviewService.createReview(requestDto, userDetails.getUsername()));
    }
    ...
    public ApiResponse<ReviewsDetailsResponseDto> toggleLikes(@PathVariable Long reviewId,
                                                              @Parameter(hidden = true) @AuthenticationPrincipal UserDetailsImpl userDetails) {
